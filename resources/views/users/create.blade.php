...
<html lang="en">
  <head>
    ...
    <title>Car Switch Registration</title>
    <!-- Google font-->
          ...
          <div class="login-card">
            <div>
              ...
              <div class="login-main"> 
                <form class="theme-form" action="{{ url('users') }}" method="post">
                    @csrf
                  ...
                  <p class="mt-4 mb-0">Already have an account?<a class="ms-2" href="{{ url('/') }}">Sign in</a></p>
                </form>
              </div>
            </div>
          </div>
